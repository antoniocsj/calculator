...
// o caminho para a biblioteca compartilhada libmpc.so depende do sistema operacional.
...
String getSharedLibraryPath() {
  if (Platform.isLinux) {
    return 'linux/external/libmpc.so';
...
final DynamicLibrary _mpc = DynamicLibrary.open(getSharedLibraryPath());
