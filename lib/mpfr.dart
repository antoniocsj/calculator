...
// o caminho para a biblioteca compartilhada libmfr.so depende do sistema operacional.
// quando o sistema operacional é Linux, a biblioteca compartilhada é carregada a partir do diretório external.
// e quando o sistema operacional é android a biblioteca compartilhada é carregada a partir do diretório jniLibs.
String getSharedLibraryPath() {
  if (Platform.isLinux) {
    return 'linux/external/libmpfr.so';
...
final DynamicLibrary _mpfr = DynamicLibrary.open(getSharedLibraryPath());
